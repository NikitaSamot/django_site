...
class OrderitemQueryset(models.QuerySet):
    ...
    def total_price(self):
        return sum(orderitem.products_price() for orderitem in self)
...
class Order(models.Model):
    user = models.ForeignKey(to=User, verbose_name="Пользователь", on_delete=models.SET_DEFAULT, default=None, blank=True, null=True)
